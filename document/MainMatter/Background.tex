...
\begin{table}[htbp]
\centering
\caption{Estadísticas del Archivo ISIC (Corte 2024--2025).}\label{tab:isic-stats}
\begin{tabular}{lr}
\toprule
...
claras. Esta marcada asimetría compromete severamente la equidad algorítmica, propiciando fallos 
...
financiera y supervivencia estratégica ante las restricciones externas.


\subsection{Economía del Etiquetado y Curación de Datos}\label{sec:etiquetado}
...
dermatólogos expertos~\cite{datavlab_annotation,medrxiv_preannotation}.

Cuba cuenta con una red de hospitales y especialistas que pueden generar este conocimiento como parte de 
su práctica clínica e investigativa, eliminando la necesidad de importar servicios de anotación 
costosos~\cite{fundacionuh_taller}.
...
Finalmente, este esfuerzo fortalecerá el vínculo entre la universidad y el sistema de salud, transformando 
