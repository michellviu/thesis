...
los flujogramas de información, los esquemas de bases de datos y la estructuración del diseño 
teórico-práctico. El \textbf{Capítulo \ref{ch:implementation}} detalla la Implementación tecnológica, 
precisando las herramientas, los lenguajes y los resultados algorítmicos tangibles en el contexto del 
ecosistema. Finalmente, la obra cierra enunciando de forma sintetizada las conclusiones a las que se arriban 
