...
\begin{itemize}
    \item Estudiar las principales bases de imágenes anotadas de la dermatología a 
    ...
    \item Posibilitar la obtención de disímiles estadísticas 
...
la integración multimodal de recolección \textit{in the wild}\footnote{El término \textit{in the wild} (en estado salvaje) se emplea en inteligencia artificial y visión por computadora para referirse a la adquisición de datos en entornos del mundo real, no controlados (sujetos a variaciones de iluminación, oclusiones y ruido técnico), en contraposición a las imágenes capturadas bajo condiciones estrictas de laboratorio.} ---mediante dispositivos móviles en 
...
práctico: diseñar e implementar una arquitectura flexible para una base de imágenes dermatoscópicas 
que integre de manera coherente metadatos clínicos locales y se acople fluidamente con las aplicaciones 
web y móviles del Ecosistema DermaUH, eleva la organización y trazabilidad de los 
...
del producto de \textit{software}. Entre las herramientas utilizadas se encuentra: Gemini de Google, ChatGPT de OpenAI 
y Claude de Anthropic. En ambos escenarios, estas tecnologías fueron empleadas fundamentalmente 
para concebir la estructura base inicial deseada, proporcionando un punto de partida organizativo sólido. 
En el caso particular de la redacción del documento, su uso se centró específicamente en la asistencia para 
la composición y mejora de párrafos y oraciones, asegurando la fluidez del texto.
...
como recurso de apoyo para la corrección y depuración de errores de baja complejidad como errores de sintaxis, 
contribuyendo a la optimización del proceso de desarrollo sin comprometer 
